...
import {IAssetsGroup} from "../interface/IAssetsToLoad";
...
export class SlotAssetsLoader extends AssetsLoader {
    ...
    protected getSlotAssetsJsonPath(data: string, isCommon: boolean): string {
    ...
    protected getSlotAssetsUrlPath(data: string, isCommon: boolean): string {
        const langFolder: string = isCommon ? "common" : GameInfo.lang;
        return ("data/assets/" + langFolder + "/" + data);
    }

    protected getBitmapFontsPath(data: string, isCommon: boolean): string {
        const langFolder: string = isCommon ? "common" : GameInfo.lang;
        return ("data/bitmapFonts/" + langFolder + "/" + data);
    }

    protected slotLoadProgressHandler(initialQueue: IAssetsGroup[], priority: string) {
        this.dispatcher.dispatch(LoadEvents.LOAD_PROGRESS, LoaderModel.currentGroupSize(this.currentPriorityID));
