...
export class BaseLabel extends BaseViewComponent {
    ...
    protected MAX_MULTISTYLE_WIDTH: number = 900;
    protected _sourceData: ILabelConfig;

    protected _textField: PIXI.Text;
    protected _sourceText: String;
    protected _scaleToWidth: boolean = false;
    protected _scaleToHeight: boolean = false;
    protected _isMultiStyle: boolean = false;
    protected dataTextStyle: {};
    protected _width: number;
    protected _height: number;
    protected _localKey: string;
    protected _isCustom: boolean;
    ...
    constructor(data: ILabelConfig) {
        ...
        if (data.multiStyle) {
            ...
            const styles: any[] = Object.values(data.multiStyle);

            if (data.multiStyle["default"]["wordWrapWidth"] > this.MAX_MULTISTYLE_WIDTH && DeviceInfoService.isMobile) {
                const scaleFactor: number = this.MAX_MULTISTYLE_WIDTH / data.multiStyle["default"]["wordWrapWidth"];
    ...
    public setText(value: string, setLeft: boolean = false): void {
        if (setLeft) {
    ...
    public alignText(): void {
        ...
        const textFieldWidth: number = this._textField.getLocalBounds().width;
        switch (this.align) {
            case "left":
                this._textField.x = 0;
                break;
