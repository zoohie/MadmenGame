...
export class RealityCheck {
    constructor(isFreezeTime) {
        // create instance of listener
        this.dispatcher = EventDispatcher.getInstance();
        this.saveNotExpiredLimitTime = () => {
            sessionStorage.setItem('notExpiredLimitTime', (RealityCheckModel.isFrozen
                ? 0
     ...
     * @returns {boolean}
     */
    checkOn24HoursExcess() {
        const isExcess = (Date.now() - RealityCheckModel.startTime) / (24 * 60 * 60 * 1000) >= 24;
        if (isExcess)
            this.dispatcher.dispatch(CoreEvents.PLAYING_OVER_24_HOURS); // TODO: remove if redundant (see also CoreEvents.ts)
        return isExcess;
    }
    /**
...
* */
//# sourceMappingURL=RealityCheck.js.map