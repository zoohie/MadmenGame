...
export class AdditionalInfoController {
    ...
    static createPopup() {
        ...
        if (CommonInitServerResponse.skinParams.aams_show_ticket) {
            const text = CommonInitServerResponse.skinParams.aams_ticket_label || LocalUtil.text(this.AAMS_TICKET_LOCAL_ID);
        ...
        if (CommonInitServerResponse.skinParams.aams_show_session) {
            const text = CommonInitServerResponse.skinParams.aams_session_label || LocalUtil.text(this.AAMS_SESSION_LOCAL_ID);
...
AdditionalInfoController.AAMS_TICKET_LOCAL_ID = "AAMS TICKET ID";
AdditionalInfoController.AAMS_SESSION_LOCAL_ID = "AAMS SESSION ID";
//# sourceMappingURL=AdditionalInfoController.js.map